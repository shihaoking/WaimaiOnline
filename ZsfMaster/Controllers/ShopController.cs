    ...
    public class ShopController : Controller
    {
        ...
        public ActionResult CancelAllUserOrders()
        {
            ...
            if(result)
                ...
                return Json(new { status = 0, msg = "取消订单失败" }, JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpPost]
        public ActionResult AddUserOrderDetail(int shopId, int disheId, short price, short count)
        {
            ...
            {
                return Json(new { status = 0, msg = "添加菜品失败，失败信息" + ex.Message }, JsonRequestBehavior.AllowGet);
            }
        ...
        [HttpPost]
        public ActionResult DeleteUserOrderDetail(int orderId)
        {
            ...
            {
                return Json(new { status = 0, msg = "删除菜品失败，失败信息" + ex.Message }, JsonRequestBehavior.AllowGet);
            }

            return Json(new { status = 1, msg = orderId }, JsonRequestBehavior.AllowGet);
        }
