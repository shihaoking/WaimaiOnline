...
namespace System.Web.Mvc
{
    public class MobileCapableRazorViewEngine : RazorViewEngine
    {
        ...
        {
            string overrideViewName = controllerContext.HttpContext.Request.Url.Host == "m.zhaishifu.com"
                || IsMobile(controllerContext.HttpContext.Request.UserAgent)
                                          ? "Mobile/" + viewName
                                          : viewName;
        ...
        public static bool IsMobile(string agent)
        {
            ...
            agent = agent.ToLower();
            if (agent.Contains("android") || agent.Contains("uc") || agent.Contains("iphone"))
                return true;
            return false;
        }
    }
